...
class Unichem_biothings_sdkDumper(biothings.hub.dataload.dumper.LastModifiedFTPDumper):
    ...
    self.download("ftp://ftp.ebi.ac.uk/pub/databases/chembl/UniChem/data/oracleDumps/UDRI283/UC_SOURCE.txt.gz", os.path.join(DATA_ARCHIVE_ROOT, "UC_SOURCE.txt.gz"), headers={})
